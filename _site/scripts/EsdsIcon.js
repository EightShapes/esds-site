    ...
    __commitText(value) {
        ...
        if (node === this.endNode.previousSibling &&
            ...
            if (this.textSanitizer === undefined) {
                this.textSanitizer = sanitizerFactory();
            }
