...
const componentProps = {
  button: convertDocsToPropsTableFormat(buttonDocs),
  card: convertDocsToPropsTableFormat(cardDocs),
  dataTable: convertDocsToPropsTableFormat(dataTableDocs),
  icon: convertDocsToPropsTableFormat(iconDocs),
  listGroup: convertDocsToPropsTableFormat(listGroupDocs),
  tabs: convertDocsToPropsTableFormat(tabsDocs),
  thumbnail: convertDocsToPropsTableFormat(thumbnailDocs),
};
...
fs.writeFileSync(
  path.join("src", "_data", "componentProps.json"),
